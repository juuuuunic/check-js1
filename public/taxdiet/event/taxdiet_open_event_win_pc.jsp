...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/openEvent_win.css' />">
	...
	<div class="popWrap">
		<div class="pop-layer" id="popup-a">
			<div class="header"> 
                ...
                <img src="../images/event/openEvent_win_tit.png" alt="오픈이벤트 당첨자 안내"> 
			...
			<div class="popup_contnet">
				...
				<div class="event-txt">
					이벤트에 참여해주신 모든 분들께 대단히 감사드리며, 당첨되신 회원님들 축하드립니다.<br />
                    경품 지급과 관련해서는 응모해주신 카카오 채널 1:1채팅으로 개별 안내해드리겠습니다.  

				</div>
			</div>
			<div class="popup_bottom"> <a id="noMoreToday" href="#none;">오늘 하루 보지 않기</a></div>
		</div>
	</div>
</body>
</html>