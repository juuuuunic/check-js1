...
(function($, window, undefined) {
	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [],
			verticalOffset: 0,
			initialText: '기간선택', // placeholder text - shown when nothing is selected
...
//				showCurrentAtPos: 1 // bug; use maxDate instead
				maxDate: 1000 // the maximum selectable date is today (also current month is displayed on the last position)
			}
		},
